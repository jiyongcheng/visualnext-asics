...
var ConfigurableMediaImages = {
    ...
    updateImage: function(el) {
        ...
        var smallImgUrl = ConfigurableMediaImages.productImages[productId]['option_labels'][label]['configurable_product']['swatch_image'];
        var swatchImage = ConfigurableMediaImages.getImageObject(productId, swatchImageUrl);
        console.log('begin swap image');
        ProductMediaManager.swapImage(swatchImage,smallImgUrl);
    },
