jQuery(document).ready(function(){
	...
	/********************************************************** Product View Accordion *********************************************************************/
		...
		jQuery('.box-collateral').not('.box-up-sell').find('h2').append('<span class="toggle opened"></span>');
	...
	/******************************************************************** Header Buttons *********************************************************************/
		...
		jQuery('.header-button, .switch-show').not('.top-login,#topmenu-category-list').on("click", function(e){
    ...
    jQuery('#topmenu-category-list').on('click',function(){
    	var test1 = jQuery('#topmenu-category-list').attr('class').include('active');
    	var test2= jQuery('#topmenu-category-list ul:first').is(':hidden');
        if( test1&& !test2) {
            jQuery('#topmenu-category-list').removeClass('active');
            jQuery('#topmenu-category-list ul').slideUp();
            jQuery('.header-button, .switch-show').not(this).find('ul').slideUp()
            jQuery('.header-button ul li, .switch-show ul li').click(function(e){
                e.stopPropagation();
            });
