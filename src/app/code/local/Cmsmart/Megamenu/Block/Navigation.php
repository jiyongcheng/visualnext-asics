...
class Cmsmart_Megamenu_Block_Navigation extends Mage_Catalog_Block_Navigation
{
   ...
   public function _prepareLayout()
    {
        ...
        if (!Mage::getStoreConfig('megamenu/mainmenu/enabled')) return false;
   ...
   protected function _renderCategoryMenuItemHtml($category, $level = 0, $isLast = false, $isFirst = false,
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
		...
		if($childrenCount && isset($megamenu[0]) && isset($megamenu[0]['category_children']) && $megamenu[0]['category_children']==0) {
        ...
        }elseif(isset($megamenu[0]) && ($megamenu[0]['active_product']==1)) {
            $html[] = '<span style="color:'.$this->fontcolor($megamenu).';">' . $this->escapeHtml($category->getName()).$this->getLabel($megamenu).'</span><span class="spanchildren"></span>';
        }elseif (isset($megamenu[0]) && $megamenu[0]['active_static_block']==1) {
            $html[] = '<span style="color:'.$this->fontcolor($megamenu).';">' . $this->escapeHtml($category->getName()).$this->getLabel($megamenu).'</span><span class="spanchildren"></span>';
        }else {
    ...
    public function widthp($idc){
        ...
        $width_menu = Mage::getStoreConfig('megamenu/mainmenu/width_menu');
                ...
                if(isset($width[0]) && ($width[0]['active_static_block'] == 1 )&& ($width[0]['active_static_block_left'] == 1 ) && ($width[0]['active_static_block_right'] == 1 )) {
                        $widthchildrenli = $width_menu -  $width[0]['width_block_left'] -  $width[0]['width_block_right']-30-10;
                    } else {
                           if(isset($width[0]) && ($width[0]['active_static_block'] == 1 )&& ($width[0]['active_static_block_left'] == 1 ) && ($width[0]['active_static_block_right'] == 0 )) {
                                $widthchildrenli = $width_menu -  $width[0]['width_block_left']-(30*$column)-30;   
                            } else {
                                if(isset($width[0]) && ($width[0]['active_static_block'] == 1 )&& ($width[0]['active_static_block_left'] == 0 ) && ($width[0]['active_static_block_right'] == 1 )) {
