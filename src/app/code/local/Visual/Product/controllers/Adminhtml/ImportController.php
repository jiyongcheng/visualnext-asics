<?php
class Visual_Product_Adminhtml_ImportController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function newAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('product/adminhtml_import_edit'));
        $this->_addLeft($this->getLayout()->createBlock('product/adminhtml_import_edit_tabs'));
            ...
            try {
                ...
                if ($uploadFile) {
                    ...
                    while($csvAdapter->valid())
                    {
                        ...
                        $productId = Mage::helper('product')->createSimpleProduct($product);
                        $products[$rowNo][] =$productId;
                        $csvAdapter->next();   // to next line
                    }

                    //Mage::log($products);
                    Mage::helper('product')->createConfigurableProduct($products);
